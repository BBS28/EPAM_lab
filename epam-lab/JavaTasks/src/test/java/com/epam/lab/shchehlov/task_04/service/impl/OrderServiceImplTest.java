...
public class OrderServiceImplTest {
    ...
    public void before() {
        ...
        OrderRepositoryImpl orderRepository = new OrderRepositoryImpl(orders);
    ...
    public void shouldReturnSizeThreeWhenGetByDate() {
        ...
        int actualSize = orderService.getByDate(date).size();
    ...
    public void shouldReturnRightDateWhenGetClosestDate() {
        ...
        assertEquals(expectedBasket, orderService.getByClosestDate(date));
    }
    ...
    @Test
    public void shouldReturnSizeOneWhenGetAllWithParameters() {
        int expectedSize = 1;
        ...
        assertEquals(expectedSize, orderService.getOrdersForPeriod(date1, date2).size());
    }
}
