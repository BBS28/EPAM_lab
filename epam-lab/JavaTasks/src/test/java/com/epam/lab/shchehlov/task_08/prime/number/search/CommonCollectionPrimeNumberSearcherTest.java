...
public class CommonCollectionPrimeNumberSearcherTest {
    private CommonCollectionPrimeNumberSearcher searcher;

    @Before
    public void before() {
        searcher = new CommonCollectionPrimeNumberSearcher();
    }
